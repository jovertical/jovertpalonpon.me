  ...
  <Layout>
    ...
    <section className="tw-bg-blue tw-px-5 tw-pt-16 tw-pb-40 tw-text-center">
      ...
      <Text variant="h6" className="lg:tw-w-1/2 tw-mx-auto tw-text-white">
        ...
        with my colleagues in developing applications that can help the society.
        Throughout the years {`I've`} expanded my knowledge from front-end stuff
        to back-end and then DevOps. I only follow a basic principle:{' '}
        ...
        <div className="tw-w-full lg:tw-w-1/3 tw-px-2 tw-mb-5 lg:tw-mb-0">
          <div className="tw-h-full tw-text-center tw-p-8 tw-bg-white tw-rounded tw-border hover:tw-shadow-lg">
            ...
            <Text className="tw-h-32 tw-mb-10">
              I love to convert a design into code, ensure that it is responsive
              and cross-browser compatible.I always tries to be the {`"user"`}{' '}
